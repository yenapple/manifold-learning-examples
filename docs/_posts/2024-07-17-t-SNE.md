...
{% include figure popup=true image_path="{{site.baseurl}}/assets/images/T-SNE/k_vs_R of T-SNE-1row.png" alt="Radius change as k varies" caption="Radius change as k varies" %}
